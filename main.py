...
def print_hi(name):
    ...
    col_files = [[sg.Listbox(values=fnames, change_submits=True, size=(60, 30), key='listbox')],
                 [sg.Button('Exit', size=(8, 1)),
                  sg.Button('Deselect', size=(8, 1)),
                  sg.Button('Prev', size=(8, 1)),
                  sg.Button('Next', size=(8, 1)),
                  sg.Button('Select', size=(8, 2)),
                  sg.Button('Set RAW-Folder', size=(9, 3)),
                  sg.Button('xCopy', size=(8, 2)),
